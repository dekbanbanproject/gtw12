...
?>
     ...
     <label >{{$infoleaveover->OVER_YEAR_ID}}</label>
      ...
      <div class="col-lg-1">
        <input  name = "DAY_LEAVE_COLLECT"  id="DAY_LEAVE_COLLECT" class="form-control input-lg" style=" font-family: 'Kanit', sans-serif;" value="{{ number_format($infoleaveover->DAY_LEAVE_COLLECT,1)}}">
      </div>
      <div class="col-lg-1">
        <label >วัน</label>
      </div>
