                ...
                <div class="d-flex align-items-center">
                    ...
                    <a class="link-fx font-size-lg font-w600 text-white" href="">
                        ...
                        <span class="text-white-50"></span><span class="text-white"
                            style="font-weight: normal;font-family: 'Kanit', sans-serif;">สุขภาพบุคลากร</span>
                    </a>
                    <!-- END Logo -->
                    ...
                    <div id="main-navigation" class="d-none d-lg-block ">
                        <ul class="nav-main nav-main-horizontal nav-main-hover ">
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/healthdashboard*') ? ' active' : '' }}"
                                    href="{{ url('manager_person/healthdashboard') }}">
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/carcalendarhealth') ? ' active' : '' }}"
                                    href="{{ url('manager_person/carcalendarhealth') }}">
                                    <i class="nav-main-link-icon fa fa-users"></i>
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ปฏิทินงาน</span>
                                </a>
                            </li>

                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/summarize*') ? ' active' : '' }}"
                                    href="{{ route('health.summarize_health_check_history') }}">
                                    <i class="nav-main-link-icon fa fa-clock"></i>
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ประวัติการตรวจสุขภาพรายบุคคล</span>
                                </a>
                            </li>

                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/inforpersonhealth') ? ' active' : '' }}"
                                    href="{{ url('manager_person/inforpersonhealth') }}">
                                    <i class="nav-main-link-icon fa fa-chart-pie"></i>
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ตรวจสุขภาพ</span>
                                </a>
                            </li>

                            <li class="nav-main-item">
                                <a class="nav-main-link{{ request()->is('manager_person/capacity_main') ? ' active' : '' }}"
                                    href="{{ url('manager_person/capacity_main') }}">
                                    <i class="nav-main-link-icon fa fa-users"></i>
                                    <span class="nav-main-link-name"
                                        style="font-size: 14px;font-family: 'Kanit', sans-serif;">ทดสอบสมรรถภาพ</span>
                                </a>
                            </li>
