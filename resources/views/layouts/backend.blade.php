        ...
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-dark main-content-narrow">
            ...
            <aside id="side-overlay">
                ...
                <div class="content-side ">  
                    <div class="row ml-3">
                        <div class="col-md-12">
                            <label><a href=" https://drive.google.com/drive/folders/1K1ScT_BTl2RGY4wno04NUilrHzFTF-n4?fbclid=IwAR1pPQxqa-qADhCq4u_OEmah7s65XkFdAJ8l9CK4Ru6RJmhr2lHd9omCjvs" target="_blank">คู่มือการใช้งาน</label></a>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <label > 
                                <a href="{{ url('youtube/youtubeuser_personcheckinindex/'.$user_id) }}" target="_blank">
                                    <i class="nav-main-link-icon fa fa-history mr-2"></i> <span class="nav-main-link-name loadscreen">ลงเวลาปฏิบัติงาน</span> 
                                </a>
                            </label>
                        </div>
                        <div class="col-md-12">
                                ...
                                <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                                    <i class="nav-main-link-icon fa fa-calendar-alt mr-2"></i> <span class="nav-main-link-name loadscreen">ข้อมูลการลา</span>
                                </a>
                            </label> 
                        </div>
                        <div class="col-md-12">
                                ...
                                <a href="{{ url('youtube/youtubeuser_persondevindex/'.$user_id) }}" target="_blank">
                                    <i class="nav-main-link-icon fa fa-handshake mr-2"></i> <span class="nav-main-link-name loadscreen">ประชุม/อบรม/ดูงาน</span>
                                </a>
                            </label>
                        </div>
                        <div class="col-md-12">
                            ...
                            <a href="{{ url('youtube/youtubeuser_compensationindex/'.$user_id) }}" target="_blank"> 
                                <i class="nav-main-link-icon fa fa-hand-holding-usd mr-2"></i> <span class="nav-main-link-name loadscreen">เงินเดือนค่าตอบแทน</span>
                            </a>
                        </label>
                        </div>
                        <div class="col-md-12">
                        ...
                        <a href="{{ url('youtube/youtubeuser_guesthouseindex/'.$user_id) }}" target="_blank"> 
                                <i class="nav-main-link-icon fa fa-hotel mr-2"></i><span class="nav-main-link-name loadscreen">สวัสดิการบ้านพัก</span> 
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        ...
                        <label >
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-atlas mr-2"></i> <span class="nav-main-link-name loadscreen">งานสารบรรณ</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label >
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-users mr-2"></i> <span class="nav-main-link-name loadscreen">งานบริการห้องประชุม</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label >
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-truck mr-2"></i> <span class="nav-main-link-name loadscreen">งานบริการยานพาหนะ</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label >
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank"> 
                            <i class="nav-main-link-icon fa fa-boxes mr-2"></i> <span class="nav-main-link-name loadscreen">งานบริหารทรัพย์สิน</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label >
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-donate mr-2"></i><span class="nav-main-link-name loadscreen">งานพัสดุ</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        ...
                        <a href="{{ url('youtube/youtubeuser_warehouse/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-box-open mr-2"></i> <span class="nav-main-link-name loadscreen">คลังวัสดุ</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label>
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-wrench mr-2"></i> <span class="nav-main-link-name loadscreen">งานแจ้งซ่อมบำรุง</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label >
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-table mr-2"></i> <span class="nav-main-link-name loadscreen">ตารางเวรปฏิบัติงาน</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label>
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-calendar-check mr-2"></i> <span class="nav-main-link-name loadscreen ">ตารางจัด OT</span>  
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label>
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-1x fa-tshirt mr-2"></i> <span class="nav-main-link-name loadscreen">งานซักฟอก</span>
                        </a>
                    </label>
                        </div>
                        <div class="col-md-12">
                        <label class="mr-2">
                        <a href="{{ url('youtube/youtubeuser_gleaveindex/'.$user_id) }}" target="_blank">
                            <i class="nav-main-link-icon fa fa-1x fa-dolly-flatbed mr-2"></i> <span class="nav-main-link-name loadscreen">งานจ่ายกลาง</span>
                        </a>
                    </label>
                        </div>
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                                ...
                                @if(request()->is('person_work/personworkjobdescription/*') || request()->is('person_work/personworkcorecompetency_detail/*') || request()->is('person_work/personworkfuntionalcompetency_detail/*') || request()->is('person_work/personworkcorecompetency_setup/*') || request()->is('person_work/personworkfuntionalcompetency_setup/*') || request()->is('person_work/personworkkpi/*')  )
                                    <a class="nav-main-link active" href="{{ url('person_work/personworkjobdescription/'.$user_id) }}">
                                ...
                                @else
                                    ...
                                    <a class="nav-main-link{{ request()->is('person_work/personworkjobdescription/*') ? ' active' : '' }}" href="{{ url('person_work/personworkjobdescription/'.$user_id) }}">
                                        <i class="nav-main-link-icon fa fa-address-card"></i>
                                        <span class="nav-main-link-name loadscreen">ข้อมูลการทำงาน</span>    
                                    </a>
                                @endif
                        ...
                        @if($check4 == 'True')
                                ...
                                @if(request()->is('person_leave/personleaveindex/*') || request()->is('person_leave/personleavetype/*') || request()->is('person_leave/addpersonleavesick/*') || request()->is('person_leave/personleaveinfo/*') || request()->is('person_leave/personleavesearch/*') || request()->is('person_leave/personleaveinfoapp/*') || request()->is('person_leave/personleaveinfover/*') || request()->is('person_leave/personleaveinfolastapp/*'))
                        ...
                        <li class="nav-main-item">
                            @if(request()->is('person_dev/persondevindex/*') || request()->is('person_dev/personmeetinginside/*') || request()->is('person_dev/persondevinfo/*') || request()->is('person_dev/persondevver/*') || request()->is('person_dev/personmeetinginside_add/*') || request()->is('person_dev/personmeetinginside_edit/*') || request()->is('person_dev/persondevadd/*') || request()->is('person_dev/persondevedit/*') || request()->is('person_dev/persondevcancel/*') )
                        ...
                        <a class="nav-main-link{{ request()->is('general_document/*') ? ' active' : '' }}" href="{{ url('general_document/genodocdocumententer/'.$user_id)}}">
                    ...
                    @if($check9 == 'True')
                        <li class="nav-main-item">
                            @if(request()->is('general_meet/genmeetindex') || request()->is('general_meet/genmeetroom/*') || request()->is('general_meet/genmeetroominfo/*') || request()->is('general_meet/genmeetroomver/*') || request()->is('general_meet/genmeetroomvercancel/*'))
                            ...
                            @else
                                <a class="nav-main-link{{ request()->is('general_meet/genmeetindex/*') ? ' active' : '' }}" href="{{ url('general_meet/genmeetindex/'.$user_id)}}">
                                    <i class="nav-main-link-icon fa fa-users"></i>
                                    <span class="nav-main-link-name loadscreen">งานบริการห้องประชุม</span>                          
                                </a>
                            @endif
                    ...
                    <li class="nav-main-item">
                        ...
                        @if(request()->is('general_car/gencarindex') || request()->is('general_car/gencartype/*') || request()->is('general_car/gencarinfonomal/*') || request()->is('general_car/gencarinforefer/*') || request()->is('general_car/gencarnomaladd/*') || request()->is('general_car/gencarreferadd/*') || request()->is('general_car/gencarreferedit/*'))
                        ...
                        @else
                            <a class="nav-main-link{{ request()->is('general_car/gencarindex/*') ? ' active' : '' }}" href="{{ url('general_car/gencarindex/'.$user_id)}}">
                                <i class="nav-main-link-icon fa fa-truck"></i>
                                <span class="nav-main-link-name loadscreen">งานบริการยานพาหนะ</span>                          
                            </a>
                        @endif
                    ...
                    @if($check11 == 'True')
                      <li class="nav-main-item">
                        ...
                        <a class="nav-main-link{{ request()->is('general_asset/*') ? ' active' : '' }}" href="{{ url('general_asset/dashboard/'.$user_id)}}">
                    ...
                    @if($check12 == 'True')
                      ...
                      <li class="nav-main-item">
                        ...
                        <a class="nav-main-link{{ request()->is('general_suplies/*') ? ' active' : '' }}" href="{{ url('general_suplies/dashboard/'.$user_id)}}">
                    ...
                    <li class="nav-main-item">
                        ...
                        @if(request()->is('general_repair/genrepairtype') || request()->is('general_repair/genrepairnomal/*') || request()->is('general_repair/genrepairnomaladd/*') || request()->is('general_repair/genrepairnomal/edit/*') || request()->is('general_repair/genrepairnomalcancel/*') || request()->is('general_repair/genrepaircom/*') || request()->is('general_repair/genrepaircomadd/*') || request()->is('general_repair/genrepaircom/edit/*') || request()->is('general_repair/genrepaircomcancel/*') || request()->is('general_repair/genrepairmedical/*') || request()->is('general_repair/genrepairmedicaladd/*') || request()->is('general_repair/genrepairmedical/edit/*') || request()->is('general_repair/genrepairmedicalcancel/*') )
                        ...
                        <a class="nav-main-link{{ request()->is('general_repair/genrepairtype/*') ? ' active' : '' }}" href="{{ url('general_repair/genrepairtype/'.$user_id)}}">
                            <i class="nav-main-link-icon fa fa-wrench"></i>
                            <span class="nav-main-link-name loadscreen">งานแจ้งซ่อมบำรุง</span>                          
                        </a>
                        @endif
                    ...
                    <li class="nav-main-item">
                        ...
                        @if(request()->is('general_operate/genoperateindex') || request()->is('general_operate/genoperateindexset/*') || request()->is('general_operate/genoperateswap/*') || request()->is('general_operate/genoperateindexver/*') || request()->is('general_operate/genoperateindexapp/*') )
                        ...
                        <a class="nav-main-link{{ request()->is('general_operate/genoperateindex/*') ? ' active' : '' }}" href="{{ url('general_operate/genoperateindex/'.$user_id)}}">
                            <i class="nav-main-link-icon fa fa-table"></i>
                            <span class="nav-main-link-name loadscreen">ตารางเวรปฏิบัติงาน</span>                          
                        </a> 
