        ...
        <div class="col-sm-8">
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    <a class="block block-rounded block-link-pop py-3 shadow" target="_blank" href="{{$row->IPUB_LINK}}">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-3" style="over-flow:hidden">
                                        @if(empty($row->IPUB_IMG))
                                            <img id="image_upload_preview" src="{{asset('image/information_publicize.png')}}" width="100%">
                                        @else
                                            <img id="image_upload_preview" src="data:image/jpeg;base64,{{ chunk_split(base64_encode($row->IPUB_IMG)) }}" width="100%">
                                        @endif
                                </div>
