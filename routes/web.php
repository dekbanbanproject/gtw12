...
Route::match(['get','post'],'general_car/gencarinforefer/{iduser}','CarController@inforefer')->name('addcar.inforefer');
...
Route::get('general_car/gencarcallcheckdate','CarController@carcallcheckdate')->name('addcar.carcallcheckdate');
...
Route::get('manager_risk/report_riskNRLS_excel','ManagerriskController@report_riskNRLS_excel');
...
Route::match(['get','post'],'manager_car/openform_switchactive','ManagercrmController@openform_switchactive')->name('mcrm.openform_switchactive');
